...
class Board
  attr_accessor :board
  attr_reader :YELLOW_TOKEN, :RED_TOKEN, :TOP_RIGHT_BOX, :TOP_LEFT_BOX, :MID_RIGHT_BOX, :MID_LEFT_BOX, :BOTTOM_RIGHT_BOX, :BOTTOM_LEFT_BOX, :MID_TOP_BOX, :MID_BOTTOM_BOX, :MID_BOX, :LINE_VERTICAL, :LINE_HORIZONTAL
